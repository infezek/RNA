...
x = [[1, 0.3, 0.1, 0.1], [1, 0.03, 0.02, 0], [1, 1, 1, 1], [
    1, 0.4, 0.15, 1], [1, 0.9, 0.8, 0.8], [1, 0.5, 0.5, 0.9]]
...
print("\nNumero de entradas(x):", entradas,
      "Numero de padroes:", padroes, "\n")
winicial = [0, 0, 0, 0]
w = winicial
...
while ((EMQ > errodes) and (epoca < numciclos)):
    ...
    for i in range(0, padroes):
        ...
        print("Saida desejada(yd): ", "%.2f" %
              yd[i], " Saida calculada(y): ", "%.2f" % y)
...
# Padrões de Teste
xt = [[1, 0.3, 0.1, 0.1], [1, 0.03, 0.02, 0], [1, 1, 1, 1], [
    1, 0.4, 0.15, 1], [1, 0.9, 0.8, 0.8], [1, 0.5, 0.5, 0.9]]
padroest = len(xt)
